...
def sort(str_lst):
    """
    function to sort the list of string
    :param str_lst: contain list of string
    :return: list of string sorted
    """
...
def reconstruct_residual_from_patches(residual, multiple):
    """
    function to reconstruct residual from patches
    :param residual:  residual matrix
    :param multiple: hyper parameter
    :return: return the econstruct residual from patches
    """
...
def extract_image_patches(img, multiple):
    ...
    :param img: matrix of the image that need to paint
    :param multiple:  hyper parameter
    :return:  the image after exact
    """
    h, w, c = img.shape
...
def residual_aggregate(residual, attention, multiple):
    """
    function for residual aggregation module
    :param residual: residual matrix
    :param attention: attention vector
    :param multiple:  hyper parameter
    :return:
    """
...
def resize_ave(img, multiple):
    """
    function to resize image by averaging neighbors
    :param img: matrix of the image that need to paint
    :param multiple:  hyper parameter
    :return:  resize image by average neighbors
    """
...
def pre_process(raw_img, raw_mask, multiple):
    ...
    :param raw_img: raw of images
    :param raw_mask: raw of masks
    :param multiple: hyper parameter
    :return: large mask and images
    """
...
def post_process(raw_img, large_img, large_mask, res_512, img_512, mask_512, attention, multiple):
    """
    post-processing module for images and masks
    :param raw_img:  raw img
    :param large_img:  large img
    :param large_mask: large mask
    :param res_512: residual 512 matrix
    :param img_512: images 512 matrix
    :param mask_512: mask 512
    :param attention: attention vector
    :param multiple: hyper parameter
...
def wrap_frozen_graph(graph_def, inputs, outputs):
      """
      wrap frozen graph function
      :param graph_def: graph function
      :param inputs: inputs
...
def tf1_tf2(model_path):
      """
      :param model_path: module path
      :return:  return the tensorflow model with version 2.5
      """
...
def inpaint(raw_img, 
    ...
    :param raw_img: raws of images
    :param raw_mask: raws of masks
    :param multiple:  hyper parameter for the model
    :param model_path: model path
    :return:  return image after inpainiting
    """
    # pre-processing
...
def read_imgs_masks(images, marks):
    """
    return image and masks for inpainting
    :param images: list of images
    :param marks: list of masks
    :return: list of path for image and mask
    """
